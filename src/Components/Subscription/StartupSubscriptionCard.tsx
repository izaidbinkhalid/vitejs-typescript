...
const StartupSubscriptionCard: React.FC<Props> = ({ price, onClick }: Props) => {
  ...
  return (
    <Grid item xs={12} sm={12} md={6} lg={4}>
      <div className={classes.container}>
        ...
        >
          <Typography className={classes.heading}>Startup Subscription</Typography>
          <div
            style={{
              display: "flex",
        ...
        <div className={classes.infoContainer}>
          <div className={classes.flex}>
            ...
            <Typography className={classes.subHeading}>
              <span className={classes.info}>10</span> Extended Reality card
            </Typography>
          </div>
          ...
          <div className={classes.flex}>
            &#10003;
            <Typography className={classes.subHeading}>
              <span className={classes.info}>1</span> Company profile card ( allows you to
          ...
          <div className={classes.flex}>
            &#10003;
            <Typography className={classes.subHeading}>
              50% discount compared to individual Subscription
            </Typography>
          </div>
        </div>
...
export default StartupSubscriptionCard;
