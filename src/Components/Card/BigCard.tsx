...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    ...
    largePic: (props: Props) => ({
      ...
      [theme.breakpoints.down("md")]: {
        width: props.showInfo === true ? theme.spacing(11) : theme.spacing(14),
        height: props.showInfo === true ? theme.spacing(11) : theme.spacing(14)
      },
      [theme.breakpoints.down("sm")]: {
...
export const BigCard: React.FC<Props> = props => {
